...
@Component({
  selector: 'app-lavandaria-nova-fatura',
  templateUrl: './lavandaria-nova-fatura.component.html',
  styleUrls: ['./lavandaria-nova-fatura.component.css'],
})
export class LavandariaNovaFaturaComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<LavandariaNovaFaturaComponent>,
