...
@Component({
  selector: 'app-administrativos-nova-fatura',
  templateUrl: './administrativos-nova-fatura.component.html',
  styleUrls: ['./administrativos-nova-fatura.component.css']
})
export class AdministrativosNovaFaturaComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<AdministrativosNovaFaturaComponent>,
  ...
  submit() {
    ...
    const categoria = 'administrativos';
