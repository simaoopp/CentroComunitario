...
@Component({
  selector: 'app-servico-comuns-nova-fatura',
  templateUrl: './servico-comuns-nova-fatura.component.html',
  styleUrls: ['./servico-comuns-nova-fatura.component.css'],
})
export class ServicoComunsNovaFaturaComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ServicoComunsNovaFaturaComponent>,
  ...
  submit() {
    ...
    const categoria = 'servicosComuns';
